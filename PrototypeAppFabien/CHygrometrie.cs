...
Auteur : Fabien DAVID
Date de création : 25/03/2025, 10:47
...
Cette classe est spécialisée sur l'hygrométrie
...
{
    internal class CHygrometrie : CInfoMeteo
    {
        public CHygrometrie() : base() { mStrDataType = "Hygrometrie"; }
        ~CHygrometrie() { }
        public CHygrometrie(CAPI objCAPI) : base(objCAPI) 
        {
            mStrDataType = "Hygrometrie";
        }
    }
}
